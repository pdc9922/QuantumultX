...
******************************************
## 脚本说明
1. 本脚本只针对基于Quantumult X和Surge对Javascript和及WEB逆向的学习，不得用于商业用途否则后果自负。
2. 不保证脚本合法性、准确性、有效性，请根据情况自行判断，本人对此不承担任何保证责任。
3. 本人对任何脚本引发的问题概不负责，包括但不限于由脚本错误引起的任何损失和损害。
4. 如果任何单位或个人认为此脚本可能涉嫌侵犯其权利，我们将在收到认证文件确认后删除此脚本。
6. 所有直接或间接使用请仔细阅读此声明, 本人保留随时更改或补充此声明的权利, 一旦您使用了此脚本即视为您已接受此免责声明。
7. 本脚本转载于大佬Yuheng0101，作者GitHub地址：https://github.com/Yuheng0101/X
******************************************
##下载地址
[50度灰]     (https://50.aff009.net/)
[91短视频]   (https://ba65.eimkeb.com)
...
# 91短视频
^https?:\/\/.*(bmafdxt|yxlauhm|psovzwr).com/pwa.php url script-analyze-echo-response https://raw.githubusercontent.com/pdc9922/QuantumultX/main/lsp.js
# 50度灰
^https?:\/\/.*50.*api.com/pwa.php/api/(user/userinfo|MvDetail/(detail|xiao_detail)|home/(getOpenAdsAndVersion|appcenter)|system/getad) url script-response-body https://raw.githubusercontent.com/pdc9922/QuantumultX/main/lsp.js
# 微密圈
^https?:\/\/.*(wmq.*api\d+).com/pwa.php url script-analyze-echo-response https://raw.githubusercontent.com/pdc9922/QuantumultX/main/lsp.js
# 撸先生
^https?:\/\/.*hichatapi.+\/api\.php$ url script-analyze-echo-response https://raw.githubusercontent.com/pdc9922/QuantumultX/main/lsp.js
# 𝐀𝐋𝐋
